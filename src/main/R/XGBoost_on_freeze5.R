...
# Read CSV
freeze5 <- read.csv("/Users/joeri/git/dave/data/freeze5.csv.gz", stringsAsFactors = FALSE)
...
write.csv.gz(freeze5_plus_pred, "/Users/joeri/git/dave/data/freeze5_predictions_R.csv.gz", row.names = FALSE, quote = FALSE)
