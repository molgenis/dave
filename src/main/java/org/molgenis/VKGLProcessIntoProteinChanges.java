...
public class VKGLProcessIntoProteinChanges {
    ...
    public static void main(String args[]) throws Exception {
        ...
        File proteinSetWithMane = new File("/Users/joeri/git/dave/data/" + inputGenes + ".txt");
        String vkglMissenseFileName = "VKGL_apr2024_annot_missense_nodup_b38.vcf";
        File vkglMissenseLocation = new File("/Users/joeri/git/dave/data/" + vkglMissenseFileName + ".zip");

        // Output files
        // Directory to write all separate variants files to, creating 1 additional directory per gene:
        File outputBaseDir = new File("/Users/joeri/git/dave/data/genes/");
        // File with genes having 1+ variants
        File genesWithVariants = new File("/Users/joeri/git/dave/data/" + inputGenes + "-withvariants.txt");
