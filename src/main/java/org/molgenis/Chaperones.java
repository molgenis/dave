...
public class Chaperones {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // input files
        File chaperonesUniprotGenename = new File("/Users/joeri/git/vkgl-secretome-protein-stability/data/RAW/chaperones-uniprot-genename.txt");
        File bioGRID = new File("/Users/joeri/git/vkgl-secretome-protein-stability/data/RAW/BIOGRID-ORGANISM-Homo_sapiens-4.4.234.tab3.txt");

        // output files
        File chapIntBGLines = new File("/Users/joeri/git/vkgl-secretome-protein-stability/data/chap-biogrid.txt");
        File uniqGeneSymbols = new File("/Users/joeri/git/vkgl-secretome-protein-stability/data/interacting-with-chaperones-genenames.txt");
        File uniqUniprots = new File("/Users/joeri/git/vkgl-secretome-protein-stability/data/interacting-with-chaperones-uniprot.txt");
